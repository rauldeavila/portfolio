...
export const Banner = () => {
    ...
    const toRotate = [ "Game Developer", "Animator", "Web Developer"]; // words to type and delete
            ...
            <Container>
                <Row className="align-items-center">
                    <Col xs={12} md={6} xl={7}>
                        ...
                        <h1>{`Hi I'm bwulf `}<span className="wrap">{text}</span></h1>
                        <p>Lorem ipsum blablabla about me</p>
